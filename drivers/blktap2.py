...
class VDI(object):
    ...
    def _get_vdi_chain(self, cowutil, extractUuid) -> List[str]:
        ...
        #TODO(XCPNG-3500): Need to add handling of error for getParentNoCheck, e.g. corrupted VDI where we can't read parent
    ...
    def _check_journal_coalesce_chain(self, sr_uuid: str, vdi_uuid: str) -> bool:
        ...
        if path.startswith("/dev/"): #TODO(XCPNG-3501): How to identify SR type easily, we could ask XAPI since we have the sruuid (and even ref)
